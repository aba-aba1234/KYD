...
export default function ReceivedBookingsPage() {
  ...
  const { user, isAnyCaregiver, isPending, loading } = useAuth();
        ...
        <Card className="max-w-md w-full">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Solo i caregiver possono vedere le prenotazioni ricevute.
            </p>
  ...
  const myBookings = user.caregiverId
    ? (bookings ?? []).filter((b) => b.caregiverId === user.caregiverId)
    : [];
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-muted/10">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="mb-8">
          <h1 className="font-serif text-3xl font-bold">Prenotazioni ricevute</h1>
          <p className="text-muted-foreground mt-1">
            Le richieste delle famiglie che hanno prenotato i tuoi servizi.
          </p>
        </div>
          ...
          <div className="mb-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-amber-700 mt-0.5">
                Quando sarai verificato comincerai a ricevere prenotazioni dalle famiglie della tua zona.
              </div>
            </div>
          </div>
        )}
          ...
          <Card className="border-dashed">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Le nuove richieste delle famiglie compariranno qui in tempo reale.
              </p>
            </CardContent>
          </Card>
        ) : (
                  ...
                  <CardContent className="p-5 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-base font-bold">{b.familyName}</div>
